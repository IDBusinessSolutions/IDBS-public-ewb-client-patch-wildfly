...
/**
 * {@link javax.net.ssl.SSLEngine} wrapper, used by Jsse SSL conduits.
 *
...
final class JsseSslConduitEngine {
     ...
     *
     * @throws java.io.IOException if an IO exception occurs during wrapping
     */
     ...
     *
     * @throws java.io.IOException if an IO error occurs during handshake handling
     */
     ...
     *
     * @throws java.io.IOException if an IO exception occurs during unwrapping
     */
     ...
     *
     * @throws java.io.IOException if an IO exception occurs during attempt to flush
     */
     ...
     * @throws java.io.IOException if an unexpected IO exception occurs
     */
     ...
     *
     * @throws java.io.IOException if an IO exception occurs during await
     */
