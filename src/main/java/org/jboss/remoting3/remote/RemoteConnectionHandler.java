...
final class RemoteConnectionHandler extends AbstractHandleableCloseable<ConnectionHandler> implements ConnectionHandler {
    ...
    public Cancellable open(final String serviceType, final Result<Channel> result, final OptionMap optionMap) {
        ...
        log.debugf("opening channel: outboundWindowSizeOptionValue = %s (default %s)", outboundWindowSizeOptionValue, RemotingOptions.OUTGOING_CHANNEL_DEFAULT_TRANSMIT_WINDOW_SIZE);
        ...
        log.debugf("opening channel: outboundMessageCountOptionValue = %s (default %s)", outboundMessageCountOptionValue, RemotingOptions.OUTGOING_CHANNEL_DEFAULT_MAX_OUTBOUND_MESSAGES);
        ...
        log.debugf("opening channel: inboundWindowSizeOptionValue = %s (default %s)", inboundWindowSizeOptionValue, RemotingOptions.INCOMING_CHANNEL_DEFAULT_RECEIVE_WINDOW_SIZE);
        ...
        log.debugf("opening channel: inboundMessageCountOptionValue = %s (default %s)", inboundMessageCountOptionValue, RemotingOptions.DEFAULT_MAX_INBOUND_MESSAGES);
        ...
        log.debugf("opening channel: outboundMessageSizeOptionValue = %s (default %s)", outboundMessageSizeOptionValue, RemotingOptions.DEFAULT_MAX_OUTBOUND_MESSAGE_SIZE);
        ...
        log.debugf("opening channel: inboundMessageSizeOptionValue = %s (default %s)", inboundMessageSizeOptionValue, RemotingOptions.DEFAULT_MAX_INBOUND_MESSAGE_SIZE);
